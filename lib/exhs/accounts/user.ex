  ...
  authentication do
    add_ons do
      ...
      confirmation :confirm_new_user do
        ...
        sender Exhs.Accounts.User.Senders.SendNewUserConfirmationEmail
      end
    end

    tokens do
      enabled? true
      token_resource Exhs.Accounts.Token
      signing_secret Exhs.Secrets
    ...
    strategies do
      magic_link do
        ...
        sender Exhs.Accounts.User.Senders.SendMagicLinkEmail
      end
      ...
      password :password do
        ...
        resettable do
          sender Exhs.Accounts.User.Senders.SendPasswordResetEmail
