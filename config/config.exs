...
# Localize (CLDR formatting + locale resolution). UI strings are handled by
# Gettext (ExhsWeb.Gettext); Localize handles dates, numbers and currency.
config :localize,
  otp_app: :exhs,
  default_locale: :da,
  supported_locales: [:da, :en]

# Gettext shows Danish by default; English msgids fall through when untranslated.
